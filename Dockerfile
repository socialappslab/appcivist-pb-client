...
RUN mkdir -p /opt/appcivist/files && mkdir -p /var/www/html/appcivist-pb && a2enmod proxy && a2enmod proxy_http && service apache2 restart && npm i npm@latest -g && npm install grunt -g && npm install bower -g
