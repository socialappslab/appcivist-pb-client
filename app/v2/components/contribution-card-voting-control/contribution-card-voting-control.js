  ...
  function contributionCardVotingControlCtrl($scope) {
    ...
    function activate() {
      if (this.ballotPaper) {
        ...
        this.candidate = this.candidateIndex ? this.candidates[this.candidateIndex] : null; // candidate object
        ...
        this.vote = this.voteIndex ? this.votes[this.voteIndex] : null; // vote object
