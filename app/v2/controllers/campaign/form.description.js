(function () {
  ...
  angular
    .module('appCivistApp')
    .controller('v2.CampaignFormDescriptionCtrl', CampaignFormDescriptionCtrl);


  CampaignFormDescriptionCtrl.$inject = [
    ...
    'moment', 'modelFormatConfig', '$translate', 'Notify'
  ];
   ...
   *   style
   */
  function CampaignFormDescriptionCtrl($scope, $sce, $http, $templateCache, $routeParams,
    $resource, $location, $timeout, localStorageService,
    Campaigns, Assemblies, Components, Contributions,
    moment, modelFormatConfig, $translate, Notify) {
