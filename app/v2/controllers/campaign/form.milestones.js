(function () {
  ...
  angular
    .module('appCivistApp')
    .controller('v2.CampaignFormMilestonesCtrl', CampaignFormMilestonesCtrl);


  CampaignFormMilestonesCtrl.$inject = [
   ...
   *   style
   */
  function CampaignFormMilestonesCtrl($scope, $sce, $http, $templateCache, $routeParams,
    $resource, $location, $timeout, localStorageService,
    Campaigns, Assemblies, Components, Contributions,
    moment, modelFormatConfig, $translate) {
