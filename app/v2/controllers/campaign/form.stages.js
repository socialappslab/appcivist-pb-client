(function () {
  ...
  angular
    .module('appCivistApp')
    .controller('v2.CampaignFormStagesCtrl', CampaignFormStagesCtrl);


  CampaignFormStagesCtrl.$inject = [
   ...
   *   style
   */
  function CampaignFormStagesCtrl($scope, $sce, $http, $templateCache, $routeParams,
    $resource, $location, $timeout, localStorageService,
    Campaigns, Assemblies, Components, Contributions,
    moment, modelFormatConfig, $translate) {
