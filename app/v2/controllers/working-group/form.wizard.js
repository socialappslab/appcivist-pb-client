(function () {
  ...
  function WgroupFormWizardCtrl($state, $stateParams, $scope) {
    ...
    if ($state.is('v2.assembly.aid.campaign.workingGroup.edit')) {
      $state.go('v2.assembly.aid.campaign.workingGroup.edit.description', {aid: $stateParams.aid, cid: $stateParams.cid, gid: $stateParams.gid});
    }
